...
class Driverless_ProxyFetcher(RequestsFetcher):
    ...
    def __init__(self, getConfig_fn, getConfigList_fn):
        ...
        self.address = (self.getConfig("driverless_proxy_address", "localhost"), int(self.getConfig("driverless_proxy_port", 23000)))
        self.retries = 0
    ...
    def get_session(self):
        ...
        cookie = Cookie(
            ...
            rest={
                'HttpOnly': True,
                'session': str(self.getConfig("driverless_proxy_session", None) or randint(1000, 9999)),
            }
        )
